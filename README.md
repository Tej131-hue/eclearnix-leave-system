🏢 ECLEARNIX Smart Leave Request System
...
├── admin.html → Manager Approval Portal
...
2. Request is stored in Firebase Realtime Database  
3. Manager portal instantly displays new requests  
